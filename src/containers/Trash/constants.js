...
export const GET_TRASH = "app/Trash/GET_TRASH";
export const GET_TRASH_SUCCESS = "app/Trash/GET_TRASH_SUCCESS";
export const GET_TRASH_FAILED = "app/Trash/GET_TRASH_FAILED";
